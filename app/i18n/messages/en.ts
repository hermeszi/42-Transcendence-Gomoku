export const messages = {
  ...
  auth: {
    ...
    passwordReset: {
      ...
      requestHeroTitle: "Find your way back in.",
      requestLede: "Enter the email on your account and Better Auth will send a secure reset link.",
      requestSubmit: "Send reset link",
      requestSubmitting: "Sending link...",
      resetTitle: "Choose a new password.",
      resetHeroTitle: "Set a fresh key.",
      resetLede: "Use the secure link from your email to finish resetting your password.",
      resetSubmit: "Reset password",
      resetSubmitting: "Resetting...",
      newPassword: "New password",
      confirmPassword: "Confirm new password",
      invalidTokenTitle: "Reset link unavailable.",
      invalidTokenBody: "This password reset link is missing, invalid, or expired.",
      requestNewLink: "Request a new link",
      backToLogin: "Back to sign in",
      boardLabel: "Secure reset board",
    },
    errors: {
      ...
      emailNotVerified: "Please verify your email before signing in. We sent a new link.",
      ...
      passwordResetUnavailable: "Unable to reset your password right now.",
  ...
  aiLobby: {
    ...
    setup: {
      ...
      playerColorLabel: "Player color",
      timeControlLabel: "Time control",
      timeControlValue: "Practice / untimed",
      showHintsLabel: "Show AI hints",
    ...
    difficulty: {
      ...
      descriptions: {
        ...
        apprentice: "Looks ahead one reply, blocks obvious threats, and still leaves chances.",
        expert: "Reads forcing lines, values defense, and randomizes among close top moves.",
        master: "Searches deeper, prunes harder, and usually answers forcing threats.",
      },
      traitValues: {
        centered: "Centered",
        local: "Local",
        uneven: "Uneven",
        openTwos: "Open twos",
        openThrees: "Open threes",
        balanced: "Balanced",
        careful: "Careful",
        pressure: "Pressure",
        forcing: "Forcing",
        clinical: "Clinical",
        forkThreats: "Fork threats",
        flexible: "Flexible",
        tactical: "Tactical",
        precise: "Precise",
    ...
    summary: {
      ...
      hintsHidden: "Hidden",
      ratingImpactLabel: "Rating Impact",
      ratingImpactValue: "Practice only",
      statusLabel: "Status",
      readyValue: "Ready",
    },
    errors: {
      soloMatchRequestFailed: "Solo match request failed ({status})",
      missingSoloMatchSession: "Solo match response was missing the match session.",
      networkStartSoloMatch: "Network error while starting the solo match.",
    },
    matchRoom: {
      page: {
        eyebrow: "vs AI Match",
        title: {
          live: "Active game vs AI",
          finished: "Solo match complete.",
        },
        lede: {
          live: "{aiName} is running {difficulty} search on the server.",
          finished: "The final position is locked.",
        },
      },
      actions: {
      ...
      board: {
        ariaLabel: "AI Gomoku board",
      },
      match: {
        lastAiMove: "Last AI move: {reason}",
        eyebrow: "Match",
        title: "State",
        match: "Match",
        board: "Board",
      ...
      errors: {
        stateRequestFailed: "State request failed ({status})",
        networkLoadState: "Network error while loading match state",
        aiTurnFailed: "AI turn failed ({status})",
        networkAiTurn: "Network error while the AI was thinking",
        networkSubmitMove: "Network error while submitting move",
        resignRequestFailed: "Resign request failed ({status})",
        networkResign: "Network error while resigning",
      },
    },
  ...
  leaderboard: {
    ...
    page: {
      ...
      pagination: "Page {page} of {totalPages} · {players} players",
      previous: "Previous",
      next: "Next",
      search: {
        player: "Player",
        playerPlaceholder: "Name or username",
        band: "Band",
        allBands: "All bands",
  ...
  profile: {
    ...
    page: {
      ...
      recentMatches: {
        ...
        search: {
          opponent: "Opponent",
          opponentPlaceholder: "Name or username",
          result: "Result",
          ...
          sortOptions: {
            newest: "Newest",
            oldest: "Oldest",
            movesDesc: "Most moves",
            movesAsc: "Fewest moves",
          },
          apply: "Apply",
          clear: "Clear",
        },
    ...
    errors: {
      ...
      passwordAlreadySet: "This account already has a password. Use Change Password instead.",
      fixHighlightedFields: "Please fix the highlighted fields.",
